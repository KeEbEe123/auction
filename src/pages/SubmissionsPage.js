    ...
    <div className="p-8 bg-custom-pattern bg-slate-950 min-h-screen flex flex-col items-center">
      ...
      {submissions.map((submission) => (
        ...
        >
          ...
          <p className="font-amsterdam text-transparent bg-clip-text bg-gradient-to-t from-slate-400 to-slate-200">
            Closing Budget: ₹{submission.closingBudget}
          </p>
          <p className="font-amsterdam text-transparent bg-clip-text bg-gradient-to-t from-slate-400 to-slate-200">
            Average Rating: {submission.averageRating}
          </p>
          <h3 className="text-xl font-starbirl text-transparent bg-clip-text bg-gradient-to-t from-blue-700 to-blue-300 mt-4">
            Submitted Players:
          </h3>
          <ul>
            {submission.submittedPlayers.map((player, index) => (
              <li
                key={index}
                className="font-amsterdam text-transparent bg-clip-text bg-gradient-to-t from-slate-400 to-slate-200"
              >
